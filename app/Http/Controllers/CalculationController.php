...
class CalculationController extends Controller
{
    ...
    //    $results = DB::select("SELECT DISTINCT(roll), name
    //     FROM student_infos
    //     where roll IN 
    ...
    //     AND roll IN
    //     (SELECT roll from student_infos WHERE course='ADAL')");

    $results = DB::select("SELECT DISTINCT(roll)
        FROM student_infos
        where roll IN 
        (SELECT roll FROM student_infos WHERE course='CN' AND semester='Fall' AND year='2022')
        AND roll IN
        (SELECT roll from student_infos WHERE course='CNL' AND semester='Fall' AND year='2022')
        AND roll IN
        (SELECT roll from student_infos WHERE course='SD' AND semester='Fall' AND year='2022')
        AND roll IN
        (SELECT roll from student_infos WHERE course='AI' AND semester='Fall' AND year='2022')
        AND roll IN
        (SELECT roll from student_infos WHERE course='AIL' AND semester='Fall' AND year='2022')
        AND roll IN
        (SELECT roll from student_infos WHERE course='MM' AND semester='Spring' AND year='2022')
        AND roll IN
        (SELECT roll from student_infos WHERE course='MML' AND semester='Spring' AND year='2022')
        AND roll IN
        (SELECT roll from student_infos WHERE course='SEISD' AND semester='Spring' AND year='2022')
        AND roll IN
        (SELECT roll from student_infos WHERE course='SEISDL' AND semester='Spring' AND year='2022')
        AND roll IN
        (SELECT roll from student_infos WHERE course='ADA' AND semester='Fall' AND year='2021')
        AND roll IN
        (SELECT roll from student_infos WHERE course='ADAL' AND semester='Fall' AND year='2021')
        ");
    ...
    private function calculatePO($roll){
        ...
        //         FROM student_infos
        //         WHERE roll='".$roll."' AND course in('DM', 'ADA', 'ADAL')");
        $pos_student = DB::select("SELECT 
                SUM(po1) as stu_po1, SUM(po2) as stu_po2, SUM(po3) as stu_po3, 
                SUM(po4) as stu_po4, SUM(po5) as stu_po5, SUM(po6) as stu_po6, 
                SUM(po7) as stu_po7, SUM(po8) as stu_po8, SUM(po9) as stu_po9, 
                ...
                AND 
                (
                    (course='AI' and semester='Fall' and year='2022')
                    OR (course='AIL' and semester='Fall' and year='2022')
                    OR (course='CN' and semester='Fall' and year='2022')
                    OR (course='CNL' and semester='Fall' and year='2022')
                    OR (course='SD' and semester='Fall' and year='2022')
                    OR (course='MM' and semester='Spring' and year='2022')
                    OR (course='MML' and semester='Spring' and year='2022')
                    OR (course='SEISD' and semester='Spring' and year='2022')
                    OR (course='SEISDL' and semester='Spring' and year='2022')
                    OR (course='ADA' and semester='Fall' and year='2021')
                    OR (course='ADAL' and semester='Fall' and year='2021')
                )");
